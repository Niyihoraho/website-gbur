...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    excerpt: [
      "Neil, now an alumnus of the University of Texas at Austin, encountered gbur not through an invitation, a roommate, or a table, but from a humble flyer.",
    ],
    author: {
      name: 'Kaitlyn Doty',
    ...
    content: [
      ...
      `A simple piece of paper taped to a bulletin board caught his eye. "gbur Bible Study - All Welcome." Those words stuck with him, and though he wasn't sure what to expect, he decided to show up the following week.`,
  ...
  },
  {
    ...
    excerpt: [
      "The more time Avelino spent growing close to his gbur community and reading the Bible, the more he wanted to share his faith with others and invite them into the community.",
    ...
    content: [
      ...
      `When he joined gbur, something shifted. The weekly Bible studies and community gatherings became a source of strength and encouragement. As he grew in his understanding of Scripture and his relationship with God, he began to see the world differently.`,
  ...
  },
  {
    ...
    image: '/Gbur/m-2.jpg',
    category: 'SCRIPTURE',
    title: "A Taste of an gbur Bible Study",
    date: 'October 25, 2025',
    excerpt: [
      "We really think an gbur Bible study is one of the best ways to learn more about Jesus and grow your faith. Try it out and experience the transformative power of Scripture.",
    ...
    content: [
      ...
      `This is what makes an gbur Bible study special. It's not about checking a box or fulfilling a requirement. It's about transformation—allowing God's Word to shape our thoughts, our actions, and our relationships.`,
  ...
  },
  {
    ...
    content: [
      ...
      `Today, Diana is a leader in the gbur community, sharing her story with others and helping create the same welcoming space that she first experienced. Her journey from curiosity to commitment is a reminder that God meets us exactly where we are.`,
  ...
  },
  {
    ...
    content: [
      ...
      `gbur communities are built on the foundation of authentic relationships. We gather not just to study together, but to share life together. We celebrate each other's victories, walk through each other's struggles, and point each other toward Christ.`,
      ...
      `The friendships formed in these communities often last far beyond graduation. Alumni consistently report that the relationships they built in gbur are among the most meaningful of their lives. These are the people who pray for you, encourage you, and challenge you to grow in your faith.`,
  ...
  },
  {
    ...
    excerpt: [
      ...
      "Our alumni continue to make a difference in their workplaces, churches, and neighborhoods, living out the values they learned in gbur.",
    ],
    author: {
    ...
    content: [
      "Read inspiring stories of how campus ministry is transforming lives and creating lasting impact in student communities nationwide.",
      "Our alumni continue to make a difference in their workplaces, churches, and neighborhoods, living out the values they learned in gbur.",
      `The impact of campus ministry extends far beyond the college years. Students who are transformed by their time in gbur go on to become leaders in their churches, workplaces, and communities, carrying the values and faith they developed on campus into every area of their lives.`,
      ...
      `These stories are not unique. Across the country, gbur alumni are making a difference. They're starting businesses with ethical practices, serving in their communities, raising families with faith-centered values, and continuing to grow in their relationship with God.`,
      ...
      `If you're a current student, know that your time in gbur is preparing you for something greater. If you're an alum, we'd love to hear your story of how campus ministry has continued to impact your life.`,
    ],
  },
  {
    id: 8,
    ...
    content: [
      ...
      `In gbur, spiritual formation happens through multiple avenues: weekly Bible studies that challenge us to engage with Scripture, discipleship relationships that provide accountability and encouragement, and community gatherings where we worship and learn together.`,
